  ...
  return (
    <Container style={{marginLeft:"165px"}}>
        ...
        <Row>
            ...
            <Col>
             <div id="card" >
             <h4 className='text-center pt-4' >Food of Rameshwaram</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
        ...
        <Col>
             <div id="card1" >
             <h4 className='text-center pt-4' >Food of Kodaikanal</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
           ...
           <Col>
           <div id="card1" >
             <h4 className='text-center pt-4' >Food of Ooty</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
        ...
        <Row>
            <Col>
            <div id="card2" >
             <h4 className='text-center pt-4' >Food of Kanyakumari</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
            ...
            <Col>
            <div id="card2" >
             <h4 className='text-center pt-4' >Food of Kumbakonam</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
        ...
        <Row>
            <Col>
            <div id="card3" >
             <h4 className='text-center pt-4' >Food of Madurai</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
            ...
            <Col>
            <div id="card3" >
             <h4 className='text-center pt-4' >Food of Yercaud</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
        ...
        <Row>
            <Col className='mb-5' >
            <div id="card3">
             <h4 className='text-center pt-4' >Food of Hogenakkal</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
            ...
            <Col>
            <div id="card3" >
             <h4 className='text-center pt-4' >Food of Theni</h4>
                <p style={{textAlign:"justify",fontSize:"15px"}} className='mt-2 p-3'>
                    <span className='mx-5'>
