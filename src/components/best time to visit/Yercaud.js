...
const Yercaud = () => {
  ...
  return (
    <>
    <Container>
    <h4 className='mt-5'>08. Yercaud</h4>
   ...
   <div
      ...
      <Modal.Dialog id="modal"  >
        <Modal.Header closeButton onClick={handleClose}>
          <Modal.Title className='text-center'>More About Best Time To Travel To Yercaud</Modal.Title>
        </Modal.Header>

        <Modal.Body>
          <Row className='px-3'>
          <Col className='justify-content-center'>
         <Image src={require("../Gallery/yercaud1.jpeg")} className='d-block' width={100} 
        
         height={150} ></Image>
         <h6 style={{textAlign:"center",marginRight:"18px"}} >Easemytrip Source</h6>
         </Col>
         <Col className='justify-content-center'>
         <Image src={require("../Gallery/yercaud2.jpeg")} className='d-block mx-3' width={100} 
         
         height={150} ></Image>
          <h6 style={{textAlign:"center"}}>Oyorooms <br /> Source </h6>
     
         </Col>
         <Col className='justify-content-center'>
          <Image src={require("../Gallery/yercaud3.jpeg")} className='d-block mx-3' width={100} 
         height={150} ></Image>
         <h6 style={{textAlign:"center"}}>Hiveminer <br /> Source </h6>
       </Col>
         </Row>
        </Modal.Body>
      ...
      <Offcanvas show={show} onHide={handleClose}  placement='end' >
         <Offcanvas.Header closeButton>
          <Offcanvas.Title style={{textAlign:"center"}} className='px-5'>Best Time To Visit In <br />Yercaud</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
          <h6 style={{fontWeight:"bold"}}>Yercaud in Summer (March - June)</h6>
...
<h6 style={{fontWeight:"bold"}}>
    Yercaud in Monsoon (July-September)
         ...
         <p style={{textAlign:"justify",fontSize:"17px"}} ><span style={{marginLeft:"70px"}}>Yercaud experiences a hot and humid
